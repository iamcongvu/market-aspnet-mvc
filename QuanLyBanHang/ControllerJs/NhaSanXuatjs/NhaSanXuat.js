    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            $.each(res.nsx, function (key, val) {
                ...
                stringhtml += "<td>";
                stringhtml += "<button type='button' class='btn btn-xs btn-warning' onclick='GetDataForDialog(" + val.MaNSX + ")'><span class='glyphicon glyphicon-edit'></span></button>";
                stringhtml += "<button type='button' style='margin-left:10px' class='btn btn-xs btn-danger' onclick='DeleteRecord(" + val.MaNSX + ")'> <span class='glyphicon glyphicon-trash'></span></button>";
                stringhtml += "</td>";
