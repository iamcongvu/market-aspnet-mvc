    ...
    $.ajax({
        ...
        success: function (res) {
            ...
            $.each(res.ncc, function (key, val) {
                ...
                stringhtml += "<td>";
                stringhtml += "<button type='button' class='btn btn-xs btn-warning' onclick='GetDataForDialog(" + val.MaNCC + ")'><i class='fas fa-pencil-alt'></i></button>";
                stringhtml += "<button type='button' style='margin-left:10px' class='btn btn-xs btn-danger' onclick='DeleteRecord(" + val.MaNCC + ")'><i class='far fa-trash-alt'></i></button>";
                stringhtml += "</td>";
